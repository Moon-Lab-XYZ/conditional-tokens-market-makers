...
contract MarketMaker is Ownable, ERC1155TokenReceiver {
    ...
    function trade(
        int[] memory outcomeTokenAmounts,
        int collateralLimit
    ) public atStage(Stage.Running) onlyWhitelisted returns (int netCost) {
        ...
        else fees = int(calcMarketFee(uint(outcomeTokenNetCost)));
    ...
    function generateAtomicPositionId(uint i) internal view returns (uint) {
